...
<body>
    <div class="container">
        ...
        <div class="buttons">
            <a href="<?php echo e(url('adminloginPage')); ?>" class="btn">Login</a>
            <a href="<?php echo e(url('register')); ?>" class="btn">Register</a>
        </div>
    </div>
</body>
</html><?php /**PATH E:\lara\Products\crud\resources\views/welcome.blade.php ENDPATH**/ ?>