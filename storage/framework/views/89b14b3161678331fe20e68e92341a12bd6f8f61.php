...
<body>
    <a href="<?php echo e(url('/')); ?>" class="back-btn"><i class="fas fa-arrow-left"></i> Back</a>
    <div class="form-container">
        <h1 class="text-center mb-4">Admin Registration</h1>
        <form class="pure-form pure-form-aligned" action="<?php echo e(route('admin.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(url('adminloginPage')); ?>" class="float-end login-link">Already have an account</a>
        </form>
    </div>
</body>
</html><?php /**PATH E:\lara\Products\crud\resources\views/register.blade.php ENDPATH**/ ?>