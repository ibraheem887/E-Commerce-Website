...
<body>
    ...
    <div class="form-container">
        ...
        <form class="pure-form pure-form-aligned" action="<?php echo e(url('login')); ?>" method="Get">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-3">
            <a href="<?php echo e(route('show.register')); ?>" class="text-primary">Don't have an account?</a>
        </div>
    </div>
</body>
</html><?php /**PATH E:\lara\Products\crud\resources\views/login.blade.php ENDPATH**/ ?>