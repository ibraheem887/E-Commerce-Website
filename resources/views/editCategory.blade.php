...
<body>
    ...
    <div class="form-container">
        ...
        <form class="pure-form pure-form-aligned" action="{{ route('category.update', $categories->id ) }}" method="Post"  >
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="category">categories</label>
                <input type="text" class="form-control" name="category" value="{{$categories->category}}">
                <span>
                    @error('category')
                        {{$message}}
                    @enderror
